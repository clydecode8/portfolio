...
export const projects: Project[] = [
...

  {
    ...
    title: "AI Customer Support Management System",
    date: "2025",
    category: "Full Stack / AI Integration",

    short:
      "Customer service platform integrating AI chatbot assistance, backend services, and containerized deployment.",


    overview:
      "A full-stack customer support management system designed to improve customer service workflows through centralized request handling and AI-assisted responses. The platform combines traditional customer management features with a machine learning chatbot service to enhance user interaction and automate common support queries.",
    ...
    links: [
      {
        title: "Source Code",
        url: "https://github.com/clydecode8/CustomerServicePlatform",
        type: "GitHub",
        icon: "/icons/github.webp"
      }
    ],
